...
First, in VS Code, in the `cloud-native-workshop-v2m2-labs` project, open `monolith/src/main/webapp/app/css/coolstore.css`, which contains the CSS stylesheet for the
CoolStore app.
