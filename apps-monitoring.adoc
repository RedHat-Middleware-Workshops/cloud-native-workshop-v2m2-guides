...
Add the necessary Quarkus _micrometer-registry-prometheus_ extensions to the Inventory application using the following commands in a CodeReady terminal:
